  ...
  return (
    <>
      <HeroSection
        title="Chuks  Kitchen"
        variant="hero--sm"
        image="./images/welcome-2.webp"
        paragraph="Chuks  Kitchen Nigerian Home Cooking 4.8  (1.2k)"
      />
      <section className="section py-24 md:py-9.5 px-4 md:px-20.5">
        <ul className="relative flex flex-col mb-14.25 gap-4.5 py-6.5 md:rounded-t-[14px] bg-white text-black">
          ...
          <li className='text-big-title font-medium flex items-center h-14 bg-light-orange before:content-[""] before:absolute before:start-0 ps-6 before:w-1 before:h-14 before:bg-primary-orange'>
            Popular
          </li>
          <li className="ps-6 text-big-title font-medium">
            Jollof Rice & Entrees
          </li>
