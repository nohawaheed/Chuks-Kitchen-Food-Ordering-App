  ...
  return (
    <>
      <HeroSection
        ...
        buttonTitle="Discover what’s new"
        image="./images/welcome.webp"
        paragraph="Handcrafted with passion, delivered with care."
      />
      {/* popular categories */}
      <section className="section relative py-24 md:py-34.25 px-4 md:px-13.75">
        ...
        <div className="flex items-center gap-1.25 sm:gap-4 rounded-lg px-3.75 py-1.75 sm:p-4 absolute left-1/2 -translate-x-1/2 -top-7.25 sm:-top-5.75 bg-white text-charcoal-black-text shadow-penumbra w-[clamp(320px,80%,1069px)]">
          ...
          <input
            ...
            className="w-full placeholder-charcoal-black-text"
          />
        </div>
        <h2 className="title text-section-title font-semibold text-center mb-8.25 sm:mb-12.5">
          Popular Categories
        </h2>
        <div className="row">
          {popularCategories.map((category) => (
            <div key={category.id} className="card card--category">
              <img
                ...
                className="w-full"
              />
              <h3 className="font-semibold text-small-title">
                {category.title}
              </h3>
            </div>
          ))}
      ...
      <section className="section py-24 md:py-29 px-4 md:px-15">
        <h2 className="title text-center mb-8.25 sm:mb-12.5">
          Chef's Specials
        </h2>
        <div className="row">
      ...
      <HeroSection
        ...
        paragraph="Explore exciting new dishes, crafted with the freshest
      ingredients and authentic Nigerian flavors. Limited time
      offer!"
        heading="h2"
        image="./images/new-menu.webp"
        buttonTitle="Discover what’s new"
      />
    </>
  );
