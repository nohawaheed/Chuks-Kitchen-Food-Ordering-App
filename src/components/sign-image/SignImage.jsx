...
function SignImage() {
  return (
    <div className='hidden relative xl:flex flex-col justify-center items-center min-h-256 w-177.5 max-w-177.5 text-white bg-[url("/images/sign-image.png")] bg-cover bg-center h-screen'>
