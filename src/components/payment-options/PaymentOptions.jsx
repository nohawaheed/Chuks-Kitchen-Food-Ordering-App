    ...
    <div className="flex flex-col max-w-157.75 lg:w-157.75 m-auto mt-15 gap-6 px-1.75 md:px-5 py-4.5 rounded-lg bg-white">
          ...
          <div className="flex gap-2.5 p-2.5 justify-between">
            <div className="flex gap-1.5 md:min-w-45.75">
              <input
                ...
                checked
              />
              <label className="text-text font-medium" htmlFor="Card">
                Card
              </label>
            </div>
            <div className="flex gap-1.5 md:min-w-45.75">
              <input type="radio" id="Bank" name="paywith" value="Bank" />
              <label className="text-stroke font-medium" htmlFor="Bank">
                Bank
              </label>
            </div>
            <div className="flex gap-1.5 md:min-w-45.75">
              <input
                ...
                value="Transfer"
              />
              <label className="text-stroke font-medium" htmlFor="Transfer">
                Transfer
              </label>
            </div>
          </div>
      ...
      <div className="flex flex-col gap-2.5 py-2.5 font-medium">
        <div className="flex flex-col gap-4">
          ...
          <input
            className="ps-4 py-3 rounded-sm ring-[1px] ring-inset ring-stroke placeholder:text-stroke"
        ...
        <div className="flex gap-4">
          <input
            className="rounded-xs ring-[1.5px] ring-inset ring-stroke"
            type="checkbox"
            id="saveCard"
          />
          <label className="text-stroke" htmlFor="saveCard">
            Save card details
          </label>
        </div>
      </div>
      <div className="flex flex-col gap-4 w-full">
        <Button onClick={onClick} title="Pay ₦9,900" />
        <p className="text-gray text-small font-medium md:font-normal">
