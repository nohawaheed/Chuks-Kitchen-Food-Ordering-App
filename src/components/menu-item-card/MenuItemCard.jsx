...
function MenuItemCard({title, description, image, price}) {
  return (
    <div className='card card--menu'>
      <img src={image} alt={title} className='w-full max-w-27 sm:max-w-full rounded-[14px] md:rounded-t-[14px] md:rounded-b-none'/>
      <div className='card__body'>
        ...
        <div className="menu-card__action">
          ...
          <button className='bg-primary-orange px-[3.6px] py-0.75 md:px-1.5 md:py-1.25 rounded-[64.23px] md:rounded-[107px] text-white'>
