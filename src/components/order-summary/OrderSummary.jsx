  ...
  return (
    <div className="flex flex-col max-w-216 lg:w-216 m-auto mt-15 gap-5.75 px-2.25 md:px-4 py-5 rounded-sm bg-white">
      ...
      <div className="flex flex-col gap-2.5 py-2.5">
        <h3 className="text-small-title font-semibold md:font-medium">
          Add a Promo Code
        </h3>
        <div className="flex gap-2.5">
          <input
            className="w-full placeholder:text-black px-2.5 py-3.75 ring ring-inset ring-stroke rounded-lg"
            type="text"
      ...
      <div className="flex w-full">
        ...
        <button className="w-1/2 text-white bg-stroke px-2.5 py-3.75 rounded-tr-lg rounded-br-lg">
          Pick up
        </button>
      </div>
      <div className="flex flex-col gap-2.5">
      ...
      <Button onClick={onClick} title="Proceed to Checkout" />
    </div>
  );
}
